...
class TransactionMembershipController extends Controller
{
    public function index(Request $request)
    {
        ...
        $items = TransactionMembership::query()
            ->with(['transaction', 'memberType', 'member'])
        ...
        return view('admin.transactions.memberships', compact('items', 'filters'));
    }
}
